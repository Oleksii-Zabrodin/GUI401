...
CPP_SRCS += \
../ViewModel/VideoChannelMenuViewModel.cpp 

OBJS += \
./ViewModel/VideoChannelMenuViewModel.o 

CPP_DEPS += \
./ViewModel/VideoChannelMenuViewModel.d 


# Each subdirectory must supply rules for building sources it contributes
ViewModel/%.o ViewModel/%.su ViewModel/%.cyclo: ../ViewModel/%.cpp ViewModel/subdir.mk
...
clean: clean-ViewModel

clean-ViewModel:
	-$(RM) ./ViewModel/VideoChannelMenuViewModel.cyclo ./ViewModel/VideoChannelMenuViewModel.d ./ViewModel/VideoChannelMenuViewModel.o ./ViewModel/VideoChannelMenuViewModel.su

.PHONY: clean-ViewModel
